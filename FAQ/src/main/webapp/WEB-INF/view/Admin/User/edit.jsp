...
<rapid:override name="content">
	...
	<blockquote class="layui-elem-quote">
		<span class="layui-breadcrumb" lay-separator="/"> <a
			href="/admin">首页</a> <a href="/admin/user">用户列表</a> <a><cite>编辑用户</cite></a>
		</span>
	</blockquote>
	<br>
	<br>
	<form class="layui-form" action="/admin/user/editSubmit" id="userForm"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" value="${userCustom.userName}" name="userName"
					id="userName" required lay-verify="userName" autocomplete="off"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="password" name="userPass"
					value="${userCustom.userPass}" id="userPass" required
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" name="userNickname"
					value="${userCustom.userNickname}" required placeholder=""
		...
		<div class="layui-form-item">
			<label class="layui-form-label">Email <span
				style="color: #FF5722;">*</span></label>
			<div class="layui-input-inline">
				<input type="email" name="userEmail" value="${userCustom.userEmail}"
					id="userEmail" required lay-verify="userEmail" class="layui-input"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="url" name="userUrl" value="${userCustom.userUrl}"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="radio" name="userStatus" value="1" title="正常"
					<c:if test="${userCustom.userStatus==1}">checked</c:if>> <input
					type="radio" name="userStatus" value="0" title="禁用"
					<c:if test="${userCustom.userStatus==0}">checked</c:if>>
			</div>
		</div>
		<div class="layui-form-item">
			<div class="layui-input-block">
