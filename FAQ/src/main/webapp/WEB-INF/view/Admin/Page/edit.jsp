...
<rapid:override name="content">
	<blockquote class="layui-elem-quote">
		<span class="layui-breadcrumb" lay-separator="/"> <a
			href="/admin">首页</a> <a href="/admin/page">页面列表</a> <a><cite>编辑页面</cite></a>
		</span>
	</blockquote>
	...
	<form class="layui-form" method="post" id="myForm"
		...
		<div class="layui-form-item">
			<label class="layui-form-label">别名<span
				style="color: #FF5722;">*</span></label>
			<div class="layui-input-inline">
				<input type="text" name="pageKey" lay-verify="key" id="key"
					value="${pageCustom.pageKey}" class="layui-input">
			</div>
		...
		<div class="layui-form-item">
			<label class="layui-form-label">标题 <span
				style="color: #FF5722;">*</span></label>
			<div class="layui-input-inline">
				<input type="text" name="pageTitle" lay-verify="title" id="title"
					value="${pageCustom.pageTitle}" class="layui-input">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="radio" name="pageStatus" value="1" title="显示"
					<c:if test="${pageCustom.pageStatus==1}">checked</c:if>> <input
					type="radio" name="pageStatus" value="0" title="隐藏"
