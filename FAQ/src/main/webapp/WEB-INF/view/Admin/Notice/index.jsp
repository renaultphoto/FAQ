...
<rapid:override name="content">
	...
	<blockquote class="layui-elem-quote">
		<span class="layui-breadcrumb" lay-separator="/"> <a
			href="/admin">首页</a> <a><cite>公告列表</cite></a>
		</span>
	</blockquote>
	...
	<table class="layui-table">
		...
		<tbody>
			<c:forEach items="${noticeCustomList}" var="c">
				...
				<tr>
					<td><a href="/notice/${c.noticeId}" target="_blank">${c.noticeTitle}</a>
					</td>
					<td>${fn:substring(c.noticeContent,0 ,30 )}......</td>
					<td>${c.noticeOrder}</td>
					<td><c:choose>
					...
					<td><a href="/admin/notice/edit/${c.noticeId}"
						class="layui-btn layui-btn-mini">编辑</a> <a
						href="/admin/notice/delete/${c.noticeId}"
