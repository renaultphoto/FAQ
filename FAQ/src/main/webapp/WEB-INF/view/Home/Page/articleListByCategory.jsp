			...
			<c:when test="${articleListVoList!=null}">
				<c:choose>
					<c:when test="${articleListVoList.size()!=0}">
						<a
							href="/category/${articleListVoList[0].categoryCustomList[0].categoryId}">${articleListVoList[0].categoryCustomList[0].categoryName}</a>
					</c:when>
					<c:otherwise>
							...
							<article class="post">
								...
								<header class="entry-header">
									<h2 class="entry-title">
										<a href="/article/${a.articleCustom.articleId}" rel="bookmark">
											${a.articleCustom.articleTitle} </a>
									</h2>
								</header>
								<!-- .entry-header -->
								...
								<div class="entry-content">
									...
									<span class="title-l"></span> <span class="new-icon"> <c:choose>
											...
											rel="external nofollow"> <i class="fa fa-comment-o"></i>
												<c:choose>
								...
								<span class="entry-more"> <a
									href="/article/${a.articleCustom.articleId}" rel="bookmark">阅读全文
								</a>
								</span>
							</article>
						</c:forEach>
						...
						<div class="nav-links">
							<c:choose>
								...
								<c:otherwise>
									...
									<c:set var="end"
										value="${articleListVoList[0].page.pageNow + 2}" />
									<c:if test="${begin < 2 }">
										<c:set var="begin" value="1" />
							...
							<c:if test="${end < articleListVoList[0].page.totalPageCount }">
								<a
									href="/category/${articleListVoList[0].categoryCustomList[0].categoryId}/p/${articleListVoList[0].page.totalPageCount}">
