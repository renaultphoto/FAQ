...
<rapid:override name="breadcrumb">
	...
	<nav class="breadcrumb">
		...
		</a> <i class="fa fa-angle-right"> ${pageCustom.pageTitle} </i> <i
	...
	<div id="primary" class="content-area">
		...
		<article class="post">
			<header class="entry-header">
				<h1 class="entry-title">${pageCustom.pageTitle}</h1>
			</header>
			<!-- .entry-header -->
			<div class="entry-content" style="min-height: 400px;">
				<div class="single-content">${pageCustom.pageContent}</div>
				...
				<footer class="single-footer">
					...
					<div class="single-cat-tag">
						<div class="single-cat">
							日期：
							<fmt:formatDate value="${pageCustom.pageCreateTime}"
								pattern="yyyy年MM月dd日" />
						</div>
					</div>
				</footer>
