...
<rapid:override name="left">
	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main"> <c:choose>
			<c:when test="${articleListVoList!=null}">
				<c:choose>
					<c:when test="${articleListVoList.size()!=0}">
						<%--文章列表-start--%>
						<c:forEach items="${articleListVoList}" var="a">
							...
							<article class="post" data-wow-delay="0.3s">
								...
								<span class="entry-more"><a
									href="/article/${a.articleCustom.articleId}" rel="bookmark">阅读全文</a></span>
							</article>
						</c:forEach>
						<%--文章列表-end--%>
					</c:when>
				...
				<c:if test="${articleListVoList.size()!=0}">
					...
					<nav class="navigation pagination" role="navigation">
						<div class="nav-links">
							...
							<c:if test="${end < articleListVoList[0].page.totalPageCount }">
								<a
									href="/tag/${articleListVoList[0].tagCustomList[0].tagId}/p/${articleListVoList[0].page.totalPageCount}">
