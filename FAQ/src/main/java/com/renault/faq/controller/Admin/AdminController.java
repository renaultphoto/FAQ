package com.renault.faq.controller.Admin;
...
import com.renault.faq.util.PwdUtil;
...
import static com.renault.faq.util.Functions.getIpAddr;
...
public class AdminController {
    ...
    public String loginVerify(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String password = PwdUtil.md5Pswd(request.getParameter("password"));
